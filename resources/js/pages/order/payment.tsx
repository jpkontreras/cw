...
const SplitItemAssignment = ({ 
    ...
    const assignedTo = people.find(p => 
        assignments[p.userId]?.includes(item.id)
    );
                            ...
                            <TabsContent value="full" className="space-y-6">
                                ...
                                <Card>
                                    <CardHeader className="px-6 pt-6">
                                        ...
                                        <CardDescription>
                                            Select a suggested amount or enter custom
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="p-6 space-y-4">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center space-x-2 mt-4">
                                                ...
                                                <Label htmlFor="tip-custom" className="cursor-pointer">Custom Amount</Label>
                                            </div>
                                        </RadioGroup>
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="space-y-4 mb-6">
                                            {splitPeople.map(person => (
                                                <div key={person.userId} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                                                    <Input
                                                        value={person.name}
                                                        onChange={e => {
                                                            const updated = splitPeople.map(p =>
                                        ...
                                        {!allItemsAssigned && (
                                            <Alert className="mt-4">
                                                ...
                                                <AlertDescription>
                                                    Please assign all items before processing payment
                                                </AlertDescription>
                                            </Alert>
                                        )}
                                    </CardContent>
                                                ...
                                                {splitPeople.map(person => (
                                                    <div key={person.userId} className="space-y-2">
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            <Badge variant={person.paid ? 'default' : 'secondary'}>
                            ...
                            <CardContent className="p-6 space-y-4">
                                ...
                                {payments.length > 0 && (
                                    <>
                                        <Separator />
                                        <div className="space-y-2">
                                            <h4 className="font-medium text-sm">Previous Payments</h4>
