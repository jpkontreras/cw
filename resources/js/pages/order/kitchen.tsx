...
export default function KitchenDisplay({ orders: initialOrders, locationId }: Props) {
  ...
  const handleStatusUpdate = useCallback(async (orderId: number, action: string) => {
    ...
    try {
      // Use axios for pure JSON response
      const response = await axios.post(`/orders/${orderId}/kitchen-status`, {
        status: newStatus,
      });
    ...
    <AppLayout>
      ...
      <Page>
        ...
        <Page.Content noPadding>
          <div id="kitchen-display-content" className={cn('h-full flex flex-col', isFullscreen && 'fixed inset-0 z-50 bg-white')}>
        {/* Fullscreen header */}
        {isFullscreen && (
        ...
        {orders.length === 0 ? (
          ...
          <div className="flex-1 grid grid-cols-3 min-h-0">
            {/* New Orders Column */}
            <div className="flex flex-col border-r border-gray-200 bg-gray-50 h-full">
              <div className="border-b border-amber-200 bg-gradient-to-r from-amber-100 to-amber-50 px-6 py-4 flex-shrink-0">
                <div className="flex items-center justify-between">
            ...
            {/* Preparing Column */}
            <div className="flex flex-col border-r border-gray-200 bg-gray-50 h-full">
              <div className="border-b border-blue-200 bg-gradient-to-r from-blue-100 to-blue-50 px-6 py-4 flex-shrink-0">
                <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col bg-gray-50 h-full">
              <div className="border-b border-green-200 bg-gradient-to-r from-green-100 to-green-50 px-6 py-4 flex-shrink-0">
                <div className="flex items-center justify-between">
