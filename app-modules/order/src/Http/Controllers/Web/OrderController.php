...
class OrderController extends Controller
{
    ...
    public function start(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('orders.session', $sessionUuid);
    }
    ...
    public function checkout(Request $request, string $sessionUuid): RedirectResponse|JsonResponse
    {
        ...
        if (!$session) {
            ...
            return redirect()->route('orders.new')->with('error', 'Session not found');
        }
        ...
        if ($session->status === 'converted' && $session->order_id) {
            ...
            return redirect()->route('orders.show', $session->order_id)
